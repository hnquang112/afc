...
;(function ($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    start: function () {
      ...
      this._drawCountdownShape(Math.PI*3.5, true, true);
    ...
    _drawCountdownShape: function (endAngle, drawStroke, isInit) {
      if (drawStroke && !isInit) {
    ...
    _draw: function () {
      ...
      this._clearRect();
      this._drawCountdownShape(Math.PI*3.5, false, false);
      if (secondsElapsed < this.settings.seconds) {
        this._drawCountdownShape(endAngle, true, false);
